...
| QueryAttestationReviewedSessionsByBranch | db | Ordered review session rows | Retrieve historical review evidence by branch | Medium | Evidence retrieval ordering/completeness risk | Compensated by explicit ordering query; acceptable risk | [storage/attestation_review_db_io.go](attestation_review_db_io.go#L215) |
